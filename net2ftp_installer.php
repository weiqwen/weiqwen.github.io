...
elseif ($_GET["security_code"] != "o3oh375yze5pg9u8pvsm" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_oekwd";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=o3oh375yze5pg9u8pvsm" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="perso.ens-lyon.fr"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="wwen"></td></tr>
